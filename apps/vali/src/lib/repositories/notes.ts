...
export function normalizeNewImagePaths(imagePaths: readonly string[]): string[] {
...
export function assertPreparedImageRemoval(
...
export function assertManagedImageOwnership(
  contentMd: string,
