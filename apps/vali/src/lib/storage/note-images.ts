...
export const NOTE_UPLOAD_PLACEHOLDER_PREFIX = "vali-upload://";
...
function resolveNoteImageRoot(): string {
  const configuredUploadDirectory = process.env.VALI_UPLOAD_DIRECTORY;
...
const markdownBaseUrl = new URL("https://vali.invalid/notes");
