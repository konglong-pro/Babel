...
trash recovery, Markdown notes, and managed-image ownership behavior. SQLite is
the live source of truth; snapshot bundles are lossless exchange artifacts only.
