...
available in reading mode. While editing, **Read** opens a separate live reader
window that follows the current draft and staged images. PNG, JPEG, WebP, and GIF images up to 10 MiB can be
