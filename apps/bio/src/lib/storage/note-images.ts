...
export const NOTE_UPLOAD_PLACEHOLDER_PREFIX = "bio-upload://";
...
function resolveNoteImageRoot(): string {
  const configuredUploadDirectory = process.env.BIO_UPLOAD_DIRECTORY;
...
const markdownBaseUrl = new URL("https://bio.invalid/notes");
