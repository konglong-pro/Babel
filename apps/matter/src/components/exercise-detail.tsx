...
const EXERCISE_PROBLEM_HEADING_ID_PREFIX = "matter-exercise-problem-heading-";
const EXERCISE_ANSWER_HEADING_ID_PREFIX = "matter-exercise-answer-heading-";
const EXERCISE_SOLUTION_HEADING_ID_PREFIX = "matter-exercise-solution-heading-";
...
export function ExerciseDetail({
  ...
  const readerTriggerId = `matter-exercise-${detail?.id ?? draftKey}-reader-trigger`;
      ...
      <header className="document-header">
        <div>
          <DetachedReaderWindow
            ...
            windowKey={`matter-exercise-${detail.id}`}
            buttonLabel="Read"
          ...
          <button
            ...
            onClick={(event) => {
              prepareDetachedEditorWindow({
                ...
                windowKey: `matter-exercise-content-${detail.id}`,
  ...
  function retainStagedImages(
    ...
    setStagedImages((current) => {
      const retained = current.filter((stagedImage) => {
        const placeholder = `matter-upload://${stagedImage.token}`;
        const referenced =
        ...
        <header className="document-header">
          <div>
            <DetachedReaderWindow
              ...
              windowKey={`matter-exercise-${detail?.id ?? draftKey}`}
              buttonLabel="Read"
              buttonPortalTargetId={readerTriggerId}
              disabled={pending}
            >
