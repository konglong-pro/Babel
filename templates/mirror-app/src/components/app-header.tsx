...
export const BEFORE_NAVIGATE_EVENT = "__APP_ID__:before-navigate";
...
export function AppHeader() {
  ...
  function submitSearch(event: FormEvent<HTMLFormElement>) {
    ...
    if (!openSearchWindow(
      window,
      destination,
      "babel-__APP_ID__-search",
      { sessionStorageKeys: ["babel:__APP_ID__:pages"] },
    )) {
  ...
  return (
    <header className="app-header">
      <Link className="brand" href="/notes" aria-label="__APP_NAME__ notes home" onClick={visitHome}>
